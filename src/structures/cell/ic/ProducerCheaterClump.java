 ...
 *
 */
public class ProducerCheaterClump extends InitialCondition {

	public ProducerCheaterClump(Parameters p) {
		super(p);
		...
		for (int x = (p.W() / 2) - 4; x <= (p.W() / 2) + 4; x++) {
			for (int y = (p.W() / 2) - 4; y <= (p.W() / 2) + 4; y++) {
				AbstractCell c;
